...
class LikeComment extends GetxController {
  final dioConfig = CommonDioConfiguration();

  Future<Map<dynamic, dynamic>> likeCommentApi(video_id, comment_id) async {

    try {
      final response = await dioConfig.dio.post(
          '${Environment.host}/posts//$video_id/comment/$comment_id/like/'
      );
